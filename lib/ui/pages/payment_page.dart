                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image: NetworkImage(
                                      widget.transaction.shoes.picturePath),
                                  fit: BoxFit.cover)),
                        ),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            Text(
                              NumberFormat.currency(
                                      ...
                                      symbol: 'IDR ',
                                      decimalDigits: 0)
                                  .format(widget.transaction.shoes.price),
                  ...
                  children: [
                    ...
                    SizedBox(
                        width: MediaQuery.of(context).size.width -
                            ...
                            80,
                        child: Text(
                          widget.transaction.user.addres,
                          style: blackFontStyle3,
                          textAlign: TextAlign.right,
                        ))
                  ],
