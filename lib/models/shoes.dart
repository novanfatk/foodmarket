...
enum ShoesType { new_food, popular, recommended }
...
List<Shoes> mockShoes = [
  Shoes(
      ...
      price: 150000,
      rate: 4.2,
      types: [ShoesType.new_food, ShoesType.popular, ShoesType.recommended]),
  Shoes(
      id: 2,
      picturePath:
